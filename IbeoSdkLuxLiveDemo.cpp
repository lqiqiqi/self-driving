...
public:
	...
	void onData(const ObjectLux* const LuxObj)
	{
		logInfo << "Object ID: " << LuxObj->getObjectId()
			<< "Object BoxCenter: " << LuxObj->getObjectBoxCenter()
			<< "Object BoxSizeX: " << LuxObj->getObjectBoxSizeX()
			<< "Object BoxSizeY: " << LuxObj->getObjectBoxSizeY()
			<< "Object BoxOrientation: " << LuxObj->getObjectBoxOrientation()
			<< "Object Classification: " << LuxObj->getClassification()
			<< "Object ClassificationCertainty: " << LuxObj->getClassificationCertainty()
		        << std::endl;
